...
import com.example.biz.mvc.controller.Controller;
...
public class DispatchServlet2 extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		viewResolver.setPrefix(context.getInitParameter("view_prefix"));
		viewResolver.setSuffix(context.getInitParameter("view_suffix"));
